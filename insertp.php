...
{
    $stmt = $conn->prepare ("INSERT INTO  planet (planet_id,planet_name,solar_system_id,solar_system_name,star_id,star_name,location_no,galaxy_id,galaxy_name,dist_earth,size) VALUES (?,?,?,?,?,?,?,?,?,?,?)");
    $stmt->bind_param("isisisiisss", $planet_id,$planet_name,$solar_system_id,$solar_system_name,$star_id,$star_name,$location_no,$galaxy_id,$galaxy_name,$dist_earth,$size);
